...
| Role | Company | Impact |
|------|---------|--------|
| AI Product & Strategy Intern | **RaidoHub** | Reduced operational task time by 30% using ML solutions |
| Senior Data Engineer | **GlobalLogic** | Automated Apple Maps workflow — 4 weeks → 8 days |
| AI/ML Data Engineer | **SpringML** | Converted 70% of AI POCs into long-term client projects |

---

## 🚀 Featured Projects

### 🏥 AI Healthcare Invoice Processing — *Northwell Health*
> Hybrid OCR + NLP system supporting 30+ invoice formats  
> **Accuracy: 65% → 90% · Processing time ↓ 50% · $2M follow-on engagement**

### 🗺️ Apple Maps Workflow Automation — *Apple*
> Automated GIS data correction pipeline across geographies  
> **Update cycle: 4 weeks → 8 days · Saved 64 engineering hours/month**

### 🛣️ Pothole Detection CV System — *City of Memphis*
> Computer vision model with weather-robust image augmentation  
> **Accuracy: 70% → 90% · ~$150K annual savings · 65,000 residents impacted**

### 📊 Customer Inactivity Dashboard — *T-Mobile*
> SQL pipelines + Tableau dashboard unifying 30+ data tables  
> **Unified inactivity definition · Enabled targeted retention campaigns**

---

## 🏆 Achievements

🏅 Forte Fellow &nbsp;·&nbsp; 🎓 Merit Scholar &nbsp;·&nbsp; 💰 90% MBA Scholarship  
📊 State Rank 5 (Higher Secondary) &nbsp;·&nbsp; 🥇 District Rank 1 (Secondary)  
